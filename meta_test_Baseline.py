...
def meta_test(novel_loader, n_query = 15, pretrained_dataset='miniImageNet', freeze_backbone = False, n_way = 5, n_support = 5): 
    ...
    for ti, (x, y) in enumerate(novel_loader):
        ...
        print('Load model from: {}'.format(modelfile))
...
if __name__=='__main__':
    ...
    for idx, novel_loader in enumerate(novel_loaders):
        ...
        meta_test(novel_loader, n_query = 15, pretrained_dataset=pretrained_dataset, freeze_backbone=freeze_backbone, **few_shot_params)
